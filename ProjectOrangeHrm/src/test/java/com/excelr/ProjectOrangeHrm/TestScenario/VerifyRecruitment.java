...
public class VerifyRecruitment {
	...
	@Test(priority = 2)
	public void addCandidateForOpenVacancy() {
	...
	@Test(priority = 3)
	public void unableToAddCandidateForClosedVacancy() {
	...
	@Test(priority = 4)
	public void unableToModifyRejectedCandidateStatus() {
